...
| 包名 | 你什么时候会用它 | 常见导出 |
| --- | --- | --- |
| `@vef-framework-react/starter` | 搭应用骨架、路由、登录页、布局 | `createApp`、`createRouter`、`createApiClient`、`App`、`Layout`、`Login` |
| `@vef-framework-react/components` | 页面 UI、页面容器、CRUD 页面、表单、表格、消息通知、图标、图表 | `Button`、`Page`、`CrudPage`、`ProTable`、`Table`、`FormModal`、`FormDrawer`、`FlexCard`、`useForm`、`useDictionaryOptionsSelect`、`useDataOptionsSelect`、`PermissionGate`、`Chart` |
...
| `@vef-framework-react/hooks` | 页面层辅助 hooks | `useDictionaryQuery`、`useHasMutating`、`useAuthorizedItems`、`useDebouncedValue` |
